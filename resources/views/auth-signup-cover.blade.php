                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            <div>
                                                ...
                                                <p class="text-muted">Get your Free Bumasys account now.</p>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <form class="needs-validation" novalidate action="index">
                                                    ...
                                                    <div class="mb-4">
                                                        <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Bumasys <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> Bumasys. Crafted with <i class="mdi mdi-heart text-danger"></i> by Bumi Code</p>
                            </div>
                        </div>
                    </div>
                </div>
