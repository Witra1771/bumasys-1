                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            <div class="pb-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Bumasys - Responsive Bootstrap 5
                                        Admin Dashboard</a></h5>
                                <p class="text-info mb-2">https://themesbrand.com/velzon/index.html</p>
                                <p class="text-muted mb-2">Bumasys admin is super flexible, powerful, clean, modern &
                                    ...
                                    design in your existing project using Bumasys it is very quick and easy as it is
                                    ...
                                    <li class="list-inline-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 fs-13 ms-1">
                                                <span class="fw-medium">Bumi Code</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('assets/images/small/img-1.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('assets/images/small/img-2.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('assets/images/small/img-4.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('assets/images/small/img-5.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="col-lg-12 video-list">
                                    <div class="list-element">
                                        <h5 class="mb-1"><a href="javascript:void(0);">Admin dashboard templates
                                                - Material Design for Bumasys</a></h5>
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                                                <p class="text-muted mb-0">Bumasys admin is super flexible, powerful, clean,
                                                    ...
                                                    large projects or update design in your existing project using Bumasys it
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="mb-1"><a href="javascript:void(0);">Bumasys - The Most Popular
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="mb-1"><a href="javascript:void(0);">Bumasys Admin Dashboard
